...
def _cmd_evaluate(args: argparse.Namespace) -> None:
    config = ModelConfig(model_path=args.model, device=args.device,
...
def main() -> None:
    ...
    gen.add_argument("--crop-sizes", type=int, nargs="+", default=[512, 1024, 2048])
    ...
    ev.add_argument("--model", default=MODEL)
    ev.add_argument("--device", default="cuda")
    ev.add_argument("--tile-size", type=int, default=1024)
